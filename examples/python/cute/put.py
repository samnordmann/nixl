...
def main():
    ...
    parser.add_argument("--with-signal", action="store_true")
    ...
    def example(world):
        ...
        for iteration in range(3):
            ...
            world.exchange(with_signal=args.with_signal)
        ...
        print(
            f"rank {world.rank}: PUT{' + signal' if args.with_signal else ''} PASS",
            flush=True,
        )
